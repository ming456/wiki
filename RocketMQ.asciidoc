...
|`spring.cloud.stream.rocketmq.bindings.your-input-binding.consumer.broadcasting`|消息发送的最大字节数|false
|`spring.cloud.stream.rocketmq.bindings.your-input-binding.consumer.orderly`|消息发送的最大字节数|false
|====
